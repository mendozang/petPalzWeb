...
@Component({
  ...
  styleUrl: './agregar-vacuna.component.scss'
})
export class AgregarVacunaComponent implements OnInit {
    ...
    constructor(
      ...
      private dialogRef: MatDialogRef<AgregarVacunaComponent>,
    ...
    onSubmit(): void {
      ...
      this.http.post(`https://petpalzapi.onrender.com/api/historial-medico/${this.data.historialMedicoId}/vacunas`, requestBody)
        .subscribe(
          response => {
            console.log('Vacuna añadida correctamente', response);
